  ...
  return (
    <footer className="footer mt-auto py-4" style={{ backgroundColor: "#07072b", color: "grey" }}>
      ...
      <Row className="align-items-center justify-content-between">
        <Col md="auto">
        <h5 style={{ color: 'grey' }}>Quick Link</h5>
        </Col>
      ...
      <Col md="auto">
        ...
        <Col md="auto" style={{ textAlign: 'left' }}> {/* Aligns all content inside the Col to the left */}
          <a href="mailto:info@gigofficial.com" style={{ display: 'inline-block', width: '100%' }}> {/* Ensures the link takes the full width of the column */}
            <FontAwesomeIcon icon={faEnvelope} size="lg" className="mx-2" />
        ...
        <Row className="align-items-center justify-content-between">
          ...
          <Col md="auto">
            {/* <a href="mailto:info@gigofficial.com">
                <FontAwesomeIcon icon={faEnvelope} size="lg" className="mx-2" />
            </a> */}
            ...
            <a href="/aboutus">
              <FontAwesomeIcon icon={faWeixin} size="lg" className="mx-2" />
            </a>
            <a href="/aboutus">
              <FontAwesomeIcon icon={faTiktok} size="lg" className="mx-2" />
            </a>
            <a href="/aboutus">
